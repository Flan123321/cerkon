  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        // --- 💡 NUEVA ANIMACIÓN DE PARTÍCULAS CSS 💡 ---
        // Mueve la posición del fondo lentamente
        'particle-dance': {
      ...
      backgroundImage: {
        ...
        // --- 💡 NUEVO FONDO DE PARTÍCULAS CSS 💡 ---
        'particle-pattern': "radial-gradient(var(--tw-gradient-stops) 1px, transparent 1px)",
      },
      // --- 💡 TAMAÑO DEL PATRÓN DE PARTÍCULAS 💡 ---
      backgroundSize: {
        '20': '20px 20px',
      },
    },
